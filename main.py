...
parser.add_argument('--movie', type=str, default='21_jump_street')
...
parser.add_argument('--name', type=str, default='ckplus_model')
...
def main():
    ...
    dataset = create(name=args.dataset, batch_size=batch_size, use_gpu=args.cuda, num_workers=num_workers, movie=args.movie)
    num_classes = 5
    train_loader = dataset.trainloader
    test_loader = dataset.testloader

    model_map = {'extendNet': extendNet, 'simpleNet': simpleNet}
